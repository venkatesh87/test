...
function commonReducer(state = initState, action = {}) {
  ...
  switch (type) {
    ...
    case Actions.FETCH_SETTING_SUCCESS:
      ...
      return (
        state
          ...
          .set("expireConfig", moment().add(30, "m").unix())
      );
    ...
    case Actions.FETCH_STORE_NAME:
      return state.set("storeName", payload);
    // Country
    case Actions.FETCH_COUNTRY:
      return state.setIn(["country", "loading"], true);
    case Actions.FETCH_COUNTRY_SUCCESS:
      return state.setIn(["country", "data"], fromJS(payload)).setIn(["country", "loading"], false).setIn(["country", "expire"], moment().add(10, "days").unix()); // 10 day expire
    ...
    case Actions.FETCH_SHIPPING_METHOD_NOT_COVER_BY_ZONE_SUCCESS:
      return state.setIn(["methodsNotCoveredByZone", "data"], fromJS(payload)).setIn(["methodsNotCoveredByZone", "loading"], false);
